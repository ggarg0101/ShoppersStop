...
public class HomePage_Action {
	...
	public static void HomePage_Verify_NewsLetterSubscribe_Functionality(int iTestCaseRow) throws Exception {
		Utils.scrollingToPageElementByCordinate(1259, 5500);
		Static_Page.NewsletterEmail().click();
		try {
			Log.info("Verification for NewsLetter Subscribe Email Functionality for Empty field");
			Static_Page.NewsLetterButton().click();
			Utils.performAssertEquals(Static_Page.NewsLetterAlert(),
		...
		try {
			...
			Static_Page.NewsletterEmail().clear();
			Static_Page.NewsletterEmail().sendKeys(ExcelUtils.getCellData(iTestCaseRow, Constant.invalidEmailId));
			Static_Page.NewsLetterButton().click();
			Utils.performAssertEquals(Static_Page.NewsLetterAlert(),
		...
		try {
			...
			Static_Page.NewsletterEmail().clear();
			Static_Page.NewsletterEmail().sendKeys(ExcelUtils.getCellData(iTestCaseRow, Constant.emailId));
			Static_Page.NewsLetterButton().click();
			Utils.performAssertEquals(Static_Page.NewsLetterAlert(),
	...
	public static void FooterLinkVerification_Customer_Public(int iTestCaseRow) throws Exception {
		...
		try {
			...
			Utils.NewWindowPageHeaderValidation("SHOPPERSSTOP | START SOMETHING NEW");
	...
	public static void FooterLinkVerification_FollowUs_Public(int iTestCaseRow) throws Exception {
		try {
			...
			Home_Page.Footer_Section.Facebook_Link().click();
			Utils.NewWindowAction();

			Home_Page.Footer_Section.Pinterest_Link().click();
			Utils.NewWindowAction();

			Home_Page.Footer_Section.GooglePlus_Link().click();
			Utils.NewWindowAction();
