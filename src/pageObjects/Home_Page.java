...
public class Home_Page extends BaseClass {
	...
	public static WebElement Logout() {
		try {
			Log.info("Locating Logout element");
			element = Driver.findElement(By.xpath("html/body/main/div[6]/ul/li[4]/a"));
	...
	public static WebElement headerWishlistIcon() throws Exception {
		...
		try {
			...
			element = Driver.findElement(By.xpath("*//div[contains(@class,'user-icons')]/ul/li/a[@class='wishlist']"));
