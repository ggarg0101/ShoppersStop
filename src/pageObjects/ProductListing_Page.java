...
public class ProductListing_Page extends BaseClass {
	...
	public static WebElement product() throws Exception {
		...
		try {
			...
			element = Driver.findElement(By.xpath("//*[@id='qv-drop']/li[1]/div[1]"));
	...
	public static WebElement ProductCount() throws Exception {
		...
		try {
			...
			element = Driver.findElement(By.xpath(
					"//section[@class='product-listing-wrapper']/descendant::div[@class='pro-list-heading col-md-4']/h4/span"));
...
public static List<WebElement> DefaultAttributeFilterCategoryContainer()throws Exception {
	...
	public static List<WebElement> ProductImage()throws Exception {
		...
		try {
			...
			webElements = Driver.findElements(By
					.xpath("//ul[@id='qv-drop']/descendant::div[@class='pro-img']"));
	...
	public static WebElement ProductQuickViewTag()throws Exception {
		...
		try {
			...
			element = Driver.findElement(By
					.xpath("//ul[@id='qv-drop']/li[1]/descendant::div[@class='pro-img']/descendant::div[@class='quick-view-lbl']"));
	...
	public static class QuickViewDetails{
		...
		public static WebElement QuickViewBrandName()throws Exception {
			...
			try {
				...
				element = Driver.findElement(By
						.xpath("//div[@id='quick-view-box']/descendant::div[@class='product_details_main wishListQuickView']/descendant::h2"));
		...
		public static WebElement QuickViewProductName()throws Exception {
			...
			try {
				...
				element = Driver.findElement(By
						.xpath("//div[@id='quick-view-box']/descendant::div[@class='product_details_main wishListQuickView']/descendant::h1"));
		...
		public static WebElement QuickViewPrice()throws Exception {
			...
			try {
				...
				element = Driver.findElement(By
						.xpath("//div[@id='quick-view-box']/descendant::div[@class='product_details_main wishListQuickView']/descendant::div[@class='price_div']"));
		...
		public static List<WebElement> QuickViewSizeVariant()throws Exception {
			...
			try {
				...
				webElements = Driver.findElements(By
						.xpath("//div[@id='quick-view-box']/descendant::div[@class='product_details_main wishListQuickView']/descendant::div[@class='size_width']/ul/li"));
