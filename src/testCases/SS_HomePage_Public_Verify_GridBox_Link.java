...
/**
 * 
 * <h2 style="text-align:center;">SS_HomePage_Public_Verify_GridBox_Link</h2>
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies Grid Box details links on Home Page</p>
...
public class SS_HomePage_Public_Verify_GridBox_Link {
	...
	public void main() throws Exception {
		try {
			...
			Log.info("Verification check for home page grid box functionality successful");
			...
			Log.error("Verification check for home page grid box functionality failed");
