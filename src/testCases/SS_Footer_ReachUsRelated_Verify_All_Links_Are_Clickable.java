...
public class SS_Footer_ReachUsRelated_Verify_All_Links_Are_Clickable {
	...
	public void main() throws Exception {
		try {
			Log.info(
					"Verification check has been completed for FooterLinks related to Reach Us  - Public View started");
			HomePage_Action.FooterLinkVerification_ReachUs_Public(iTestCaseRow);
			Log.info(
					"Verification check has been completed for FooterLinks related to Reach Us  - Public View successfull");
