...
/**
 * 
 * <h2 style="text-align:center;">SS_PLP_Verify_RemoveFromWishlist_QuickView_RegisteredUser</h2>
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies Removing product from wishlist in Quick view section for product on PLP.</p>
...
public class SS_PLP_Verify_RemoveFromWishlist_QuickView_RegisteredUser {
	...
	public void main() throws Exception {
		try {
			...
			Log.info("Logged in with registered user");
			...
			PLP_Action.PLP_Verify_RemoveFromWishlist_RegisteredUser(iTestCaseRow);
			ExcelUtils.setCellData("Pass", iTestCaseRow, Constant.result);
			Log.info("Verification for Registered user links in QuickView on PLP page successfull");

		} catch (Exception e) {
			Log.info("Verification for Registered user links in QuickView on PLP page failed");
