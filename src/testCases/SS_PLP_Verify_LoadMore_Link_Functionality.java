 ...
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies load more link functionality on PLP.</p>
...
public class SS_PLP_Verify_LoadMore_Link_Functionality {
	...
	public void main() throws Exception {
		try {
			Log.info("Verification for Load More Link Functionality on PLP page started");
			PLP_Action.PLP_Verify_LoadMore_Link_Functionality(iTestCaseRow);
			ExcelUtils.setCellData("Pass", iTestCaseRow, Constant.result);
			Log.info("Verification for Load More Link Functionality on PLP page successfull");

		} catch (Exception e) {
			Log.info("Verification for Load More Link Functionality on PLP page failed");
