...
/**
 * 
 * <h2 style="text-align:center;">SS_CartPage_Private_Verify_CartPage_FromYourWishlist_Functionality</h2>
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies From Your Wishlist section on the Cart page for a registered user.</p>
...
public class SS_CartPage_Private_Verify_CartPage_FromYourWishlist_Functionality {
	...
	public void main() throws Exception {
		try {
			...
			Cart_Action.Verify_Private_Cart_Page_FromYourWishList(iTestCaseRow);
			ExcelUtils.setCellData("Pass", iTestCaseRow, Constant.result);
			Log.info("Verification for verifying from your wishlist on cart page successfull");
			Utils.captureScreenshot(sTestCaseName, "Pass", "Apply Coupan Screenshot");

		} catch (Exception e) {
			Log.info("Verification for verifying from your wishlist on cart page failed");
