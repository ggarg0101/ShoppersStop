...
/**
 * 
 * <h2 style="text-align:center;">SS_PLP_Verify_Promotion_Image_Link</h2>
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies Promotion Images link on PLP.</p>
...
public class SS_PLP_Verify_Promotion_Image_Link {
	...
	public void main() throws Exception {
		try {
			...
			Log.info("Verification for Promotion image link on PLP page successfull");

		} catch (Exception e) {
			Log.info("Verification for Promotion image link on PLP page failed");
