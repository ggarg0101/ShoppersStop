...
/**
 * 
 * <h2 style="text-align:center;">SS_Header_Public_Verify_MiniCart_Functionality</h2>
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies Mini cart details.</p>
...
public class SS_Header_Public_Verify_MiniCart_Functionality {
	...
	public void main() throws Exception {
		try {
			...
			Log.info("Verification check done for Mini Cart icon functionality successfull");
			...
			Log.error("Verification check done for Mini Cart icon functionality failed");
