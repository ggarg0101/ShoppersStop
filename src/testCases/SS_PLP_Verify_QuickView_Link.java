...
/**
 * 
 * <h2 style="text-align:center;">SS_PLP_Verify_QuickView_Link</h2>
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies Quick View link on product image on PLP.</p>
...
public class SS_PLP_Verify_QuickView_Link {
	...
	public void main() throws Exception {
		try {
			...
			Log.info("Verification for Quick View Link on Product Image on PLP page successfull");

		} catch (Exception e) {
			Log.info("Verification for Quick View Link on Product Image on PLP page failed");
